...
def get_obj_dict_from_bin_file(file_path, debug=True, to_mmdet=False, concat=False):
...
def get_pc_from_time_stamp(timestamp, path, split='training'):
    ...
    pc_root = f'/data/zhaoshenao/code/SST/data/waymo/kitti_format/{split}/velodyne'
