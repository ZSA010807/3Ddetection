...
parser.add_argument('--data-folder', type=str, default='./data/waymo/waymo_format/validation')
parser.add_argument('--output', type=str, default='./data/waymo/waymo_format/gt.bin',
