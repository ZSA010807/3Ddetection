...
def call_bin(save_path):
    ...
    ret_bytes = subprocess.check_output(
        f'./mmdet3d/core/evaluation/waymo_utils/compute_detection_metrics_main {save_path} ' + './data/ctrl_bins/validation/gt.bin', shell=True)
...
if __name__ == '__main__':
    ...
    assert args.split in ('training', 'validation', 'testing') # training for train set and validation set; testing for test set.
